                ...
                <div class="card-body p-0">
                    <div class="row no-gutters">
                        <div class="col-lg-4 bg-primary p-5 text-white d-none d-lg-block">
                            <h2 class="font-weight-bold mb-4">Nuevo Empleado</h2>
                            <p class="lead">Configura el acceso de tu personal de forma segura.</p>
                            <ul class="list-unstyled mt-5">
                                <li class="mb-3"><i class="fas fa-check-circle mr-2"></i> Datos de contacto</li>
                                <li class="mb-3"><i class="fas fa-check-circle mr-2"></i> Asignación de rol</li>
                                <li class="mb-3"><i class="fas fa-check-circle mr-2"></i> Permisos de módulos</li>
                            </ul>
                        </div>
                            ...
                            <form action="{{ route('usuarios.store') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control form-control-lg shadow-sm border-0 bg-light" placeholder="Ej: Carlos Pérez" required style="border-radius: 12px;">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="small font-weight-bold text-muted">CORREO ELECTRÓNICO</label>
                                        <input type="email" name="email" class="form-control form-control-lg shadow-sm border-0 bg-light" placeholder="carlos@negocio.com" required style="border-radius: 12px;">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="small font-weight-bold text-muted">CONTRASEÑA</label>
                                        <input type="password" name="password" class="form-control form-control-lg shadow-sm border-0 bg-light" placeholder="mínimo 8 caracteres" required style="border-radius: 12px;">
                                    </div>
                                ...
                                <div class="mt-5 d-flex justify-content-between">
                                    <a href="{{ route('usuarios.index') }}" class="btn btn-light px-4 rounded-pill">Volver</a>
                                    <button type="submit" class="btn btn-primary px-5 rounded-pill shadow font-weight-bold">CREAR USUARIO</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<style>
    ...
    .custom-switch .custom-control-input:checked ~ .custom-control-label::before { background-color: #007bff; }
